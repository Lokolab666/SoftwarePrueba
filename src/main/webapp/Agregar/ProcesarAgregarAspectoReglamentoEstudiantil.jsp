...
<body>
	...
	if (daos_AspectoEvaluado.agregarAspectoReglamentoEstudiantil(titulo, concepto, evidencia, calificacion)) {
	%>
	...
	<script lang="javascript">
		Swal.fire({
			...
			location.href = "../Listar/ListaAspectoReglamentoEstudiantil.jsp";
		});
	</script>
	<%
	} else {
